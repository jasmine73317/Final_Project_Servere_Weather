...
y_train_categorical = y_train_categorical.reshape(y_train_categorical.shape[0], 1, y_train_categorical.shape[1])
y_test_categorical = y_test_categorical.reshape(y_test_categorical.shape[0], 1, y_test_categorical.shape[1])
