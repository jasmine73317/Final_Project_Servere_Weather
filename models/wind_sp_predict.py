...
df = df.sort_values(by=["Date and Time", "City"])
df = df.loc[:,['Date and Time', 'Temperature', 'Humidity', 'Wind_Speed',
       'Wind_Direction', 'Pressure', 'Weather_Description', 'Year', 'Month',
       'Day', 'Hour','City', 'Latitude', 'Longitude']]
...
filename = 'hr_wind_speed_predict_model.h5'
